...
Planned visible-character count excluding punctuation and the small ling brand mark: {按 style-dna.md 的“文字配额”填写}
...
Ling brand appearance:
{No；或 Yes：说明把准确拼写的小号手写文字 "ling" 自然放在哪里。只用于品牌锚点，不做水印或标题}
